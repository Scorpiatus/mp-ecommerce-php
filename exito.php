                                        ...
                                        <div class="as-producttile-title">
                                            <h3 class="as-producttile-name">
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">Muchas gracias por su compra!<br>Su pago se recibió correctamente<br>A continuación le ofrecemos la información del mismo, puede guardarlo para futuras referencias.</span>
                                                </p>
                                                <ul>
                                                <?php  
